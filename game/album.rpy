...
screen album:
    ...
    hbox:
        ...
        grid 3 3:
            ...
            add gallery.make_button(name="letter1", unlocked="images/CGs/letter1.jpg", locked="gui/ending.png")
            add gallery.make_button(name="letter2", unlocked="images/CGs/letter2.jpg", locked="gui/ending.png")
            add gallery.make_button(name="letter3", unlocked="images/CGs/letter3.jpg", locked="gui/ending.png")
            add gallery.make_button(name="hidden", unlocked="images/CGs/hidden_notes.jpg", locked="gui/ending.png")
